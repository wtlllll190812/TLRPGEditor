...
namespace XNodeEditor.Internal {
	...
	public abstract class NodeEditorBase<T, A, K>: NodeEditorBase where A : Attribute, NodeEditorBase<T, A, K>.INodeEditorAttrib where T : NodeEditorBase<T, A, K> where K : ScriptableObject {
